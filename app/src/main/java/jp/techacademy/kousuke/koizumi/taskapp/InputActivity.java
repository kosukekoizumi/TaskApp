...
public class InputActivity extends AppCompatActivity {
    ...
    private EditText mCategoryEdit,mTitleEdit, mContentEdit; //★カテゴリ項目追加
    private Task mTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCategoryEdit = (EditText)findViewById(R.id.category_edit_text); //★カテゴリ追加
        ...
        if (mTask == null) {
            ...
            // 更新の場合
            mCategoryEdit.setText(mTask.getCategory()); //★カテゴリ項目追加
    ...
    private void addTask() {
        ...
        String category = mCategoryEdit.getText().toString(); //★カテゴリ項目追加
        String title = mTitleEdit.getText().toString();
        String content = mContentEdit.getText().toString();

        mTask.setCategory(category); //★カテゴリ項目追加
